...
describe('HomeHeroSection Component', () => {
    it('HomeHeroSection component renders properly', () => {
        // render component
        const component = renderer.create(
            <HomeHeroSection options={options} updateComponent={() => null} />
        )

        // get JSON version of rendered component
        let skillsComponentJSON = component.toJSON();

        let [title1, title2] = skillsComponentJSON.children[0].children[0].children;
        let [button1, button2] = skillsComponentJSON.children[0].children[2].children;
        ...
        let renderedDescription = skillsComponentJSON.children[0].children[1].children[0];
        let renderedImage = skillsComponentJSON.children[1].children[0].props.src;
    ...
    it('HomeHeroSectionOptions show correct input values',()=>{
        // render the HomeHeroSectionOptions component
        const component = renderer.create(
            <HomeHeroSectionOptions options={options} updateComponent={() => null}  />
        )
    ...
    it('HomeHeroSectionOptions handleChange function',()=>{
        ...
        const component = renderer.create(
            <HomeHeroSectionOptions options={options} updateComponent={(change) => expect(JSON.stringify(change)).eq(JSON.stringify({gradient: Gradients["green-blue"]}))}  />
        )
    ...
    it('HomeHeroSectionOptions handleButtonChange function', () => {
        ...
        // render component
        const component = renderer.create(
            <HomeHeroSectionOptions options={options} updateComponent={(change) => expect(JSON.stringify(change)).eq(JSON.stringify(changeTest))} />
        )
    ...
    it('HomeHeroSectionOptions handleImageChange function', () => {
        // create test object that the input handler should match
        const changeTest = {
            photo: "/src/components/HomeHeroSection/photo.jpg"
        }
