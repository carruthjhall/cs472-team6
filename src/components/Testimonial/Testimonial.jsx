...
export default function Testimonial({options}) {
    ...
    const union = Array.from({length: stars}, () => <img src={starSVG} className="float-left md:max-xl:mr-1 sm:mr-0"/>)

    return(
        <div className="flex flex-col items-start p-8 bg-white dark:bg-gray-900 h-fit  md:max-xl:w-[436.58px] m-4">
            ...
            <div>
                <img src={custPicture} className="md:max-xl:float-left w-14 h-14 rounded-full"/>
