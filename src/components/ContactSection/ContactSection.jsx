...
export default function ContactSection({options}){
    ...
    return (
      <a id="ContactSection">
        <div id="ContactSection" className="flex flex-col m-auto lg:w-[1200px] lg:h-[700px] md:w-[864px] md:h-[1069px] w-[400px] h-[1000px] bg-white dark:bg-black md:px-10 py-10 lg:grid lg:grid-cols-2 lg:gap-28 justify-center">
