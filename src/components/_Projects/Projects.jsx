    ...
    return (
        <div className="mx-auto w-[340px] md:w-[740px] lg:w-[1200px]">
            <div className="mb-[32px] md:w-[560px] lg:w-[1200px] lg:flex lg:flex-row lg:justify-between">
                ...
                <div className="text-white font-secondary text-[16px] md:text-[18px] lg:w-[560px] lg:my-auto">
                    {Description}
                </div>
            </div>
...
function ProjectItem({ProjectItems}) {
    ...
    return (
        <div className="w-[340px] h-[370px] lg:h-[587px] lg:w-[560px] bg-white rounded-xl mx-auto my-[40px]">
            <img className="mx-auto h-[242px] lg:h-[400px]" src={Picture}></img>
            <div className="h-[128px] lg:h-[187px] bg-gray-900">
                <div className="text-white font-main p-[29px] lg:p-[42px]">
