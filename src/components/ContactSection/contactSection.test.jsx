...
describe('Contact Section Component', () => {
    ...
    it('Text renders properly', () => {
        ...
        let contact = leftWrapper.children[0].children[3]

        let header= leftWrapper.children[0].children[0].children.shift();
        let descr = leftWrapper.children[0].children[2].children[0];
