...
export default function CaseStudyHeroOptions({options, updateComponent}){
    let {clientNameHeader, clientName, projTask, role, location, projPreview, briefDescr, extendDescr, gradient} = options;
        ...
        <div className="p-3">
            ...
            <details className="pb-1">
                <summary>Project Information</summary>
                    ...
                    <label className="block">Client Name Header:</label>
                    <input className={`block mb-3 p-2 rounded-lg bg-gray-200`} type="text" name="clientNameHeader" value={clientNameHeader} onChange={handleChange} />
