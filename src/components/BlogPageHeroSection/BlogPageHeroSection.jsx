  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="text-center pt-[238px]">
        {/* Title */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-4xl 2xl:text-5xl font-bold font-main text-black dark:text-white mb-4 mx-auto max-w-[1080px]">
        {title}
        </p>
